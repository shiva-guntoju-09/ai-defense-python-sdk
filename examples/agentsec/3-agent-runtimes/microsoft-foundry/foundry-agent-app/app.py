"""
Azure AI Foundry Agent Application - Flask App Entry Point.

This module provides a Flask web application that wraps the SRE agent
for deployment as an Azure AI Foundry managed online endpoint.
...
def health():
    """Health check endpoint for Azure AI Foundry."""
    return jsonify({
        "status": "healthy",
...
if __name__ == "__main__":
    ...
    print(f"Starting Foundry Agent App on port {port}...")
